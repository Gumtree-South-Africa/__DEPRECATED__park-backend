...
/**
 * It call the sitemap component builder with the proper values for location + categories.
 * @author Julieta Salvadó
 *
 */
@Component
public class LocationAndCategoriesSitemapComponentBuilderCaller implements SitemapComponentBuilderCaller {

    @Value("${sitemap.locations.categories.priority}")
