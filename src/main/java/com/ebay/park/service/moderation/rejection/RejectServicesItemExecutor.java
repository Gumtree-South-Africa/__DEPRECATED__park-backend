...
/**
 * It manages the item rejection when the reason of rejection is 'services'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectServicesItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_SERVICES)
