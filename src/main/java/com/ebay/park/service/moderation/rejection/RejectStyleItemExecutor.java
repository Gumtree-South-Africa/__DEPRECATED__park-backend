...
/**
 * It manages the item rejection when the reason of rejection is 'style/format'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectStyleItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_STYLE)
