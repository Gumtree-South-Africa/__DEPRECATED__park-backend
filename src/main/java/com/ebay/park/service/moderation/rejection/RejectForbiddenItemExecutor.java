...
/**
 * It manages the item rejection when the reason of rejection is 'forbidden item'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectForbiddenItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_FORBIDDEN)
