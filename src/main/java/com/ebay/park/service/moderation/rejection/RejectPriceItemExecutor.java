...
/**
 * It manages the item rejection when the reason of rejection is 'price'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectPriceItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_PRICE)
