...
/**
 * It manages the item rejection when the reason of rejection is 'animals'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectAnimalsItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_ANIMALS)
