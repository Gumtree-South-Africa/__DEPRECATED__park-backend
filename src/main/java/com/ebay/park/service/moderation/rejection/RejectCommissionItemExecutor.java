...
/**
 * It manages the item rejection when the reason of rejection is 'commission sales'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectCommissionItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_COMMISSION)
