...
/**
 * It manages the item rejection when the reason of rejection is 'makeup'.
 * @author Julieta Salvadó
 *
 */
@Component
public class RejectMakeupItemExecutor extends RejectItemExecutor {

	@Override
    @Notifiable(action=NotificationAction.ITEM_DELETED_FROM_MODERATION_MAKEUP)
