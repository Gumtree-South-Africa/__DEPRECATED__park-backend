...
@Component
public class AccountKitEmailSignInCmd implements ServiceCommand<AccountKitEmailSignInRequest, SignInResponse>{
    ...
    @Override
    public SignInResponse execute(AccountKitEmailSignInRequest param)
            throws ServiceException {
      //TODO this should be refactored because is almost exactly as sms signin
        User user = userServiceHelper.findUserByEmail(param.getEmail());
        if (user == null) {
