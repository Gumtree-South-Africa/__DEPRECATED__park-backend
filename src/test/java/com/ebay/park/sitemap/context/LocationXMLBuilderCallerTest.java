...
/**
 * Unit test for {@link LocationSitemapComponentBuilderCaller}.
 * @author Julieta Salvadó
 *
 */
public class LocationXMLBuilderCallerTest {
    ...
    @InjectMocks
    private LocationSitemapComponentBuilderCaller caller = new LocationSitemapComponentBuilderCaller();
